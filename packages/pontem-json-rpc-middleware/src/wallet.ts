...
export function createWalletMiddleware({
  ...
  async function sendTransaction(
    ...
    console.log('[Pontem] Wallet SendTransaction', req.params);
  ...
  async function validateAndNormalizeKeyholder(
    ...
    console.log('[Pontem] validateAndNormalizeKeyholder called', address);
    if (
      ...
      console.log('[Pontem] validateAndNormalizeKeyholder accounts', accounts);
      ...
      console.log('[Pontem] validateAndNormalizeKeyholder addressess', normalizedAddress, normalizedAccounts);
...
function resemblesAddress(str: string): boolean {
  ...
  // TODO check for aptos address length
  return true;
}
